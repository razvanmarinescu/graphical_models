function demoBurglar()
    ...
    try
        ...
        DictPlot[burglar]=VariablePlot("Burglar",x=0,y=0,nodesize=0.3)
        DictPlot[earthquake]=VariablePlot("Earthquake",x=2,y=0,nodesize=0.35)
        DictPlot[alarm]=VariablePlot("Alarm",x=1,y=1,nodesize=0.2)
        DictPlot[radio]=VariablePlot("Radio",x=3,y=1,nodesize=0.2)
